...
- Experienced NHS data scientist, working on predictive models using national hospital data, indicator development and training.
...
### Key skills
```{r skillzcloud, echo=FALSE, warning=FALSE, message=FALSE, fig.width=6, fig.height=4}
...
- Building on-line national benchmarking analysis tools, available from [www.hed.nhs.uk](www.hed.nhs.uk).
...
Talk for Royal Statistical Society Conference
