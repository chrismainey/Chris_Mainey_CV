...
My work focuses on modelling National Health Service (NHS) data, primarily using national Hospital Episode Statistics (HES). I work primarily in `R` and SQL Server, and have experience with statistical modelling and machine learning methods. I have recently completed my PhD at UCL, on modelling methods for NHS incident reporting data, and am currently making minor corrections.
